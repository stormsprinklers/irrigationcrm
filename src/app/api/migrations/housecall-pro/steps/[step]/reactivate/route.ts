...
import { reactivateSkippedStep, requireAdmin } from "@/lib/housecall-pro/orchestrator";
...
export async function POST(_request: NextRequest, { params }: Params) {
  try {
    ...
    const migration = await reactivateSkippedStep(
      user.companyId,
    ...
    const message = err instanceof Error ? err.message : "Failed to reactivate step";
