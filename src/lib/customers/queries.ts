...
export function serializeCustomer(customer: CustomerPayload): CustomerDTO {
  return {
    ...
    attributionChannel: customer.attributionChannel,
    attributionCampaign: customer.attributionCampaign,
    attributionSource: customer.attributionSource,
    firstTouchAt: customer.firstTouchAt?.toISOString() ?? null,
    firstTouchMethod: customer.firstTouchMethod ?? null,
    status: customer.status,
    doNotService: customer.doNotService,
    marketingEmailOptOut: customer.marketingEmailOptOut,
    marketingSmsOptOut: customer.marketingSmsOptOut,
    appointmentReminderEmailOptOut: customer.appointmentReminderEmailOptOut,
    appointmentReminderSmsOptOut: customer.appointmentReminderSmsOptOut,
    tags: customer.tags ?? [],
